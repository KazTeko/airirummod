package com.kazteko.darkairiummod.tileentity;
...
public class DarkChestTileEntity extends LockableLootTileEntity {
	...
	public DarkChestTileEntity(TileEntityType<?> typeIn) {
		super(typeIn);
	}

	public DarkChestTileEntity() {
		this(ModTileEntityTypes.DARK_CHEST.get());
	}
	...
	public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
		...
		if (blockstate.hasTileEntity()) {
			...
			if (tileentity instanceof DarkChestTileEntity) {
				return ((DarkChestTileEntity) tileentity).numPlayersUsing;
			}
		}
		return 0;
	}

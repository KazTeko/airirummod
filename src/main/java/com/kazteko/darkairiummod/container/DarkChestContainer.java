package com.kazteko.darkairiummod.container;
...
public class DarkChestContainer extends Container {
	...
	public DarkChestContainer(final int windowId, final PlayerInventory playerInventory,
			final DarkChestTileEntity tileEntity) {
		super(ModContainerTypes.DARK_CHEST.get(), windowId);
	...
	private static DarkChestTileEntity getTileEntity(final PlayerInventory playerInventory,
	...
	public boolean canInteractWith(PlayerEntity playerIn) {
		return isWithinUsableDistance(canInteractWithCallable, playerIn, blockinit.dark_chest.get());
	}

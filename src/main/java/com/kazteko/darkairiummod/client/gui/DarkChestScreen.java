package com.kazteko.darkairiummod.client.gui;
...
public class DarkChestScreen extends ContainerScreen<DarkChestContainer> {
	...
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(DarkairiumMod.MOD_ID, "textures/gui/dark_chest.png");
